...
$(function () {
    $('.tweet').twittie({
        username: 'envato',
        count: 5,
        template: '<div class="tweetblock">{{date}} - {{tweet}}</div>',
        dateFormat: '%d %B %Y',
...
This image will be displayed on the mobile device, replacing the rain video.
*/  
  
$("header").backstretch("media/video.jpg");
...
/* ================================= */
   ...
   $(function() {
   var endDate = "Dec 31, 2016 20:39:00";
  $('.countdown').countdown({
          date: endDate,
